...
99998 FORMAT ('                                    ----- PASS -----')
      END
      double precision function ddottest(n, x, incx, y, incy)
      integer n, incx, incy
      double precision x(*), y(*)
      external ddottestsub
      double precision dot

      call ddottestsub(n, x, incx, y, incy, dot)
      ddottest = dot

      return
      end

      double precision function dasumtest(n, x, incx)
      integer n, incx
      double precision x(*)
      external dasumtestsub
      double precision temp

      call dasumtestsub(n, x, incx, temp)
      dasumtest = temp

      return
      end

      double precision function dnrm2test(n, x, incx)
      integer n, incx
      double precision x(*)
      external dnrm2testsub
      double precision temp

      call dnrm2testsub(n, x, incx, temp)
      dnrm2test = temp
